        	...
        	<div class="menu">
            	<ul>
                   ...
                   <li><a href="list.html">学校概况</a></li>
                    ...
                    {pc:content action="category" catid="0" num="11" order="listorser ASC" siteid="$siteid"}
                    {loop $data $v} {if $v[catid]==19}
 ...
 <!--第一部分内容-->
  ...
  <ul class="num" id="idNum">
    ...
    <li>3</li>
           	  ...
           	  <div id="news">
                   <h1><img src="{IMG_PATH}/HBschool/news_pic_title.gif" width="430" height="50" usemap="#Map2" border="0" />
                     <map name="Map2" id="Map2">
                       <area shape="rect" coords="386,21,430,44" href="{APP_PATH}index.php?m=content&c=index&a=lists&catid=20" />
                     </map>

                   </h1>
                   <ul >

                   {pc:content action="lists" catid="20" order="inputtime DESC" num="8"}
	                   {loop $data $v}
          ...
          <div id="notice">
          	<h1><a href="{APP_PATH}index.php?m=content&c=index&a=lists&catid=21 " /><img src="{IMG_PATH}/HBschool/30.gif" width="30" height="9" /></a></h1>
            <ul>
